...
# significance tests
data = [peak_ISI_hist, width_ISI_hist, fraction_burst_ISIs, fraction_ISIs_8_25,
        shortest_ISI, CV_ISIs, fraction_ISI_or_ISI_next_burst,
        fraction_single, firing_rate, linear_slope_APonset]
columns = ['ISI peak', 'ISI width', 'ISI<8', '8<ISI<25',
                           '10% shortest ISI', 'CV ISI', 'ISI[n] or [n+1]<8',
                           'Fraction single', 'Firing rate', 'Linear slope']
